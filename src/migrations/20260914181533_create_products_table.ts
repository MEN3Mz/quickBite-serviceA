...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    CONSTRAINT fk_products_restaurant_id FOREIGN KEY (restaurant_id) REFERENCES restaurants(id) ON DELETE CASCADE,
...
export async function down(knex: Knex): Promise<void> {
  await knex.raw(`DROP TRIGGER IF EXISTS trg_product_after_insert ON products;
